...
const FIREFLY_PANEL_CONFIG = {
  ...
  description: 'Fireflies move toward brighter neighbors. Brightness is determined by fitness — dimmer fireflies are attracted to brighter ones.',
  sliders: [
    { section: 'Fitness Function', key: 'functionIndex', label: 'Function (0-3)', min: 0, max: 3, step: 1, decimals: 0 },
    { section: 'Attraction', key: 'attractiveness', label: 'Beta0', min: 0.1, max: 5, step: 0.1, decimals: 1 },
    ...
    { section: 'Swarm', key: 'fireflyCount', label: 'Fireflies', min: 5, max: 100, step: 1, decimals: 0 },
  ],
...
function buildFireflyPanel(
  ...
  fnLabel.style.cssText = 'font-size:11px;color:#aaff44;margin-top:-4px;margin-bottom:8px;padding-left:2px;';
...
register({
  id: 'firefly',
  title: 'Firefly Algorithm',
  description: 'Fireflies are attracted to brighter neighbors, with brightness determined by fitness. Less bright fireflies move toward brighter ones, converging on optimal solutions. Xin-She Yang, 2008.',
