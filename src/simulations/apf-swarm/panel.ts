...
const APF_PANEL_CONFIG = {
	...
	description:
		'Artificial Potential Fields for multi-agent path planning. Drag the goal or obstacles to interact.',
	sliders: [
		{
			section: 'Goal Attraction',
			key: 'kAtt',
			label: 'Pull strength',
			min: 0.1,
			max: 5,
...
export function buildApfPanel(
	...
	return buildPanel(panel, APF_PANEL_CONFIG, params as unknown as Record<string, number>, {
