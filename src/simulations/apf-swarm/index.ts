...
register({
  ...
  description: '10 autonomous agents navigate toward a shared goal, avoid obstacles, and maintain spacing using only local force calculations. No communication, no central controller -- just physics-inspired math.',
